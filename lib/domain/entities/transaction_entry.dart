...
class TransactionEntry extends Equatable {
  ...
  /// Returns true if this transaction is marked as recurring (legacy check or has link).
  bool get isRecurring => recurrenceFrequency != null || recurringTransactionId != null;

  /// Returns true if this transaction instance was generated by a recurring rule.
  bool get isGeneratedFromRecurring => recurringTransactionId != null;
